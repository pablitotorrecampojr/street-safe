...
export default function MapsFragment() {
    ...
    const hazardIcon = new L.DivIcon({
        ...
        html: `
            <svg class="text-danger" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-radioactive" viewBox="0 0 16 16">
    ...
    const userIcon = new L.DivIcon({
        className: 'custom-svg-icon',
        html: `
            <svg class="text-primary" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
