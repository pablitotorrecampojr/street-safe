    ...
    <div className="min-h-screen w-full font-sans bg-gray-50">
      ...
      <nav className="flex border-b text-center shadow-md">
        <div
          ...
          onClick={() => navigate('/admin_dashboard')} // ✅ Fixed navigation
        >
          Dashboard
        </div>
        ...
        <div
          ...
          onClick={() => navigate('/admin_accesscontrol')} // ✅ Added working navigation
        >
          Access Control
        </div>
      </nav>
...
export default Admin_HazardReport;
